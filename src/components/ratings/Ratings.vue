        ...
        <div class="ratings-wrapper">
            ...
            <div class="content">
                ...
                <div class="labels-view">
                    <span class="item" v-for="(item,index) in ratings.labels" :key="index" :class="{'heigligh':item.label_star>0}">{{item.content}}{{item.label_count}}</span>
                </div>
                <ul class="rating-list">
                    <li v-for="(comment,index) in selectComments" :key="index" class="comment-item">
                      <div class="comment-header">
                        ...
                        <img src="./img/anonymity.png" alt="" v-if="!comment.user_pic_url">
                      </div>
...
export default {
  ...
  created() {
    ...
    //   });
      ...
      fetch("https://wd6572388885nxklda.wilddogio.com/data.json")
      .then(res => {
        return res.json();
      })
      .then(response => {
  ...
  computed: {
    selectComments() {
      ...
      } else if (this.selectType == PICURE) {
        let arr = [];
